...
#### MacOS X
    ...
    brew install openblas glog gtest automake protobuf
...
###### Ubuntu 14.04 LTS
    sudo apt-get install libprotobuf-dev protobuf-compiler libatlas-base-dev libgoogle-glog-dev libgtest-dev python-dev python-pip libiomp-dev libopencv-dev libpthread-stubs0-dev cmake
